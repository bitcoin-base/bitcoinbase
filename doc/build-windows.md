...
Below are some notes on how to build Bitcoin Base Core for Windows.

The options known to work for building Bitcoin Base Core on Windows are:
...
Note that for WSL the Bitcoin Base Core source path MUST be somewhere in the default mount file system, for
