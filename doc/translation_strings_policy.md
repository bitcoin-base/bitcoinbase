...
This document provides guidelines for internationalization of the Bitcoin Base Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinbase_en.ts` remains unchanged.
