# Support for Output Descriptors in Bitcoin Base Core

Since Bitcoin Base Core v0.17, there is support for Output Descriptors. This is a
...
existing Bitcoin Base Core wallets, a convenience function `combo` is
...
All RPCs in Bitcoin Base Core will include the checksum in their output. Only
