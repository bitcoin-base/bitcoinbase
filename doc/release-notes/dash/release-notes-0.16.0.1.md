...
bitcoinbased/bitcoinbase-qt (on Linux). If you upgrade after DIP0003 activation and you were
...
Please check Bitcoin Core 0.16 release notes in a [section](#backports-from-bitcoin-core-016)
below and `Help -> Command-line options` in Qt wallet or `bitcoinbased --help` for more information.
...
- [`3b904a0fa1`](https://github.com/dashpay/dash/commit/3b904a0fa1) Add a note about bitcoinbase_hash under dependencies in test/README.md (#3386)
...
- [`7e3ed76e54`](https://github.com/dashpay/dash/commit/7e3ed76e54) Make a deep copy of extra_args before modifying it in set_bitcoinbase_test_params (#3270)
