...
This guide describes how to build bitcoinbased, command-line utilities, and GUI on OpenBSD.
...
Bitcoin Base Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
