...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitcoinbased
...
considered active. This is the "traditional" mode of operation for bitcoinbased.
...
**Failure consideration:** if bitcoinbased unexpectedly halts after `m_stop_use` is set on
...
When bitcoinbased initializes again, what began as the snapshot chainstate is now
