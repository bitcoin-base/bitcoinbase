...
const std::string CURRENCY_UNIT = "BCB"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BCB_KB,      //!< Use BCB/kB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BCB_KB) const;
