...
/* BitcoinbaseGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* BitcoinbaseGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Bitcoin Base"
#define QAPP_ORG_DOMAIN "bitcoinbcb.com"
#define QAPP_APP_NAME_DEFAULT "Bitcoinbase-Qt"
#define QAPP_APP_NAME_TESTNET "Bitcoinbase-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Bitcoinbase-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Bitcoinbase-Qt-regtest"
