...
{
    Q_OBJECT
    BitcoinUnit currentUnit{BitcoinUnit::BCB};
...
public:
    ...
    QSize minimumSizeHint() const override
    {
        ...
        int h = 0;
        int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnit::BCB, BitcoinUnits::maxMoney(), false, BitcoinUnits::SeparatorStyle::ALWAYS));
        w += 2; // cursor blinking space
        w += GUIUtil::bitcoinbaseThemeActive() ? 24 : 0; // counteract padding from css
        return QSize(w, h);
    }
