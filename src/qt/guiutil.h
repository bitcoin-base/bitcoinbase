...
/** Utility functions used by the Bitcoin Base Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bcb:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load bitcoinbase specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a bitcoinbase specific theme is activated (light/dark).*/
