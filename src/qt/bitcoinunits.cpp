...
QList<BitcoinUnit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(Unit::BCB);
    unitlist.append(Unit::mBCB);
    unitlist.append(Unit::uBCB);
...
QString BitcoinUnits::name(Unit unit)
{
    ...
    switch (unit) {
    case Unit::BCB:  return is_mainnet ? QString("BCB") : QString("tBCB");
    case Unit::mBCB: return is_mainnet ? QString("mBCB") : QString("mtBCB");
    case Unit::uBCB: return is_mainnet ? QString::fromUtf8("μBCB") : QString::fromUtf8("μtBCB");
...
QString BitcoinUnits::description(Unit unit)
{
    ...
    switch(unit) {
    case Unit::BCB:  return QString("Bitcoin Base");
    case Unit::mBCB: return QString("Milli-Bitcoin Base (1 / 1" THIN_SP_UTF8 "000)").arg(maybe_prefix);
    case Unit::uBCB: return QString("Micro-Bitcoin Base (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)").arg(maybe_prefix);
    case Unit::duffs: return QString("Ten Nano-Bitcoin Base (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)").arg(maybe_prefix);
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
{
    switch (unit) {
    case Unit::BCB:  return 100'000'000;
    case Unit::mBCB: return 100'000;
    case Unit::uBCB: return 100;
...
{
    switch (unit) {
    case Unit::BCB:  return 8;
    case Unit::mBCB: return 5;
    case Unit::uBCB: return 2;
...
{
    switch (unit) {
    case BitcoinUnit::BCB: return 0;
    case BitcoinUnit::mBCB: return 1;
    case BitcoinUnit::uBCB: return 2;
...
{
    switch (num) {
    case 0: return BitcoinUnit::BCB;
    case 1: return BitcoinUnit::mBCB;
    case 2: return BitcoinUnit::uBCB;
