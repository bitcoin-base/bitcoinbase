    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage: bitcoinbase-qt [command-line options] [URI]\n\n"
                         "Optional URI is a Bitcoin Base address in BIP21 URI format.\n";
...
All the Bitcoin Base in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 BCB, 0.01 BCB, 0.1 BCB, 1 BCB and 10 BCB -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%2\" href=\"%3\">%1 documentation</a>."
        ...
        .arg("https://docs.bitcoinbcb.com/en/stable/wallets/bitcoinbase/coinjoin-instantsend.html")
        );
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
