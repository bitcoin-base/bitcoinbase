...
//! Interface for the src/evo part of a dash node (bitcoinbased process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a dash node (bitcoinbased process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a dash node (bitcoinbased process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a dash node (bitcoinbased process).
...
//! Top-level interface for a dash node (bitcoinbased process).
class Node
{
public:
    virtual ~Node() {}
