...
;(function() {
  ...
  var HASH_UNDEFINED = '__lobitcoinbase_hash_undefined__';

  /** Used as the internal argument placeholder. */
  var PLACEHOLDER = '__lobitcoinbase_placeholder__';
  ...
  function runInContext(context) {
    ...
    lodash.cond = cond;
    lobitcoinbase.conforms = conforms;
    ...
    lobitcoinbase.conformsTo = conformsTo;
