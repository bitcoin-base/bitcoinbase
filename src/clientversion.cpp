 ...
 * for both bitcoinbased and bitcoinbase-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Bitcoin Base Core");
...
std::string CopyrightHolders(const std::string& strPrefix, unsigned int nStartYear, unsigned int nEndYear)
{
    ...
    // Check for untranslated substitution to make sure Bitcoin Base Core copyright is not removed by accident
    if (copyright_devs.find("Bitcoin Base Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + strprintf(" %u-%u ", 2025, nEndYear) + "The Bitcoin Base Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoin-base/bitcoinbase>";
