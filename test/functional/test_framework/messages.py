...
def dashhash(s):
    return bitcoinbase_hash.getPoWHash(s)
...
# Objects that map to bitcoinbased objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in bitcoinbased indicates these should be deserialized as blocks
