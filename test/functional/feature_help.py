...
"""Verify that starting bitcoinbased with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinbased with -h for help text")
        ...
        self.log.info("Start bitcoinbased with -version for version information")
        ...
        self.log.info("Start bitcoinbasedd with -fakearg to make sure it does not start")
