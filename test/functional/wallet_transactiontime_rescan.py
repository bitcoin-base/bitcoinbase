...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]    # node used to mine BCB and create transactions
        ...
        # generate some BCB to create transactions and check blockcount
        ...
        # send 10 BCB to user's first watch-only address
        self.log.info('Send 10 BCB to user')
        ...
        # send 5 BCB to our second watch-only address
        self.log.info('Send 5 BCB to user')
        ...
        # send 1 BCB to our third watch-only address
        self.log.info('Send 1 BCB to user')
