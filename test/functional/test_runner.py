...
BASE_SCRIPTS = [
    ...
    'feature_block.py', # NOTE: needs bitcoinbase_hash to pass
    ...
    'feature_dip3_v19.py',
    'feature_asset_locks.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_connections.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_is_retroactive.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_chainlocks.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_simplepose.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_simplepose.py --disable-spork23', # NOTE: needs bitcoinbase_hash to pass
    'feature_dip3_deterministicmns.py --legacy-wallet', # NOTE: needs bitcoinbase_hash to pass
    'feature_dip3_deterministicmns.py --descriptors', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_signing.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_signing.py --spork21', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_rotation.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_evo.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_is_cl_conflicts.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_dkgerrors.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_llmq_singlenode.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_dip4_coinbasemerkleroots.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_mnehf.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_masternode_params.py', # NOTE: needs bitcoinbase_hash to pass
    ...
    'p2p_platform_ban.py', # NOTE: needs bitcoinbase_hash to pass
    'p2p_sendheaders.py', # NOTE: needs bitcoinbase_hash to pass
    'p2p_sendheaders_compressed.py', # NOTE: needs bitcoinbase_hash to pass
    ...
    'rpc_estimatefee.py',
    'p2p_unrequested_blocks.py', # NOTE: needs bitcoinbase_hash to pass
    'feature_shutdown.py',
    'p2p_ibd_txrelay.py',
    'rpc_coinjoin.py',
    'rpc_masternode.py',
...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, attempts=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, use_term_control, skipunit=False):
    ...
    # Warn if bitcoinbased is already running
    try:
        # pgrep exits with code zero when one or more matching processes found
        if subprocess.run(["pgrep", "-x", "bitcoinbased"], stdout=subprocess.DEVNULL).returncode == 0:
            print("%sWARNING!%s There is already a bitcoinbased process running on this system. Tests may fail unexpectedly due to resource contention!" % (BOLD[1], BOLD[0]))
    except OSError:
        # pgrep not supported
        pass
