# Bootstrappable Bitcoin Base Core Builds

This directory contains the files necessary to perform bootstrappable Bitcoin Base
Core builds.
...
To build Bitcoin Base Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Bitcoin Base Core version being built.
